...
?>
 ...
 <div class="table-responsive">
                <?php
                      ...
                      FROM stockorder s
                      INNER JOIN user u ON s.eNIC= u.NIC WHERE s.NIC='$username' AND status='Supplied'";
                ...
                <table class="table table-primary table-striped table-custom table-bordered border-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php  echo $row['Name'];?></td>
                            <td>
                                    <button type="submit" name="supplybtn"class="btn btn-primary button-custom" >supplied</button>
                            </td>
                            <td>
                               <form method="post" action="php.php">
                                    <input type="hidden" name="delete_id" value="<?php  echo $row['id'];?>">
                                    <input type="hidden" name="delete_sid" value="<?php  echo $row['sid'];?>">
                                    <button type="submit" name="cancelsupply"  class="btn btn-danger button-custom">Cancel</button>
                               </form>
                            </td>
                        </tr>
                        <?php

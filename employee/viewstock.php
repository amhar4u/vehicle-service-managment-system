...
<div class="table-responsive">
                <?php
                      ...
                      FROM stock s
                      INNER JOIN user u ON s.NIC= u.NIC WHERE status='Available'";
                        ...
                        <tr>
                            ...
                            <td>
                               <form action="order.php" method="post">
                                    ...
                                    <button type="submit" name="orderbtn"class="btn btn-success button-custom" >Order</button>
                               </form>
                            </td>
                            <td>
                               <form method="post" action="db/query.php">
                                    <input type="hidden" name="delete_id" value="<?php  echo $row['id'];?>">
                                    <button type="submit" name="deletestock"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

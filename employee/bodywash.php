...
<div class="table-responsive">
                <?php
                      ...
                      $query="SELECT * FROM booking WHERE ServiceType='1' AND  DATE(Date) = DATE(NOW())";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/bodystart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/bodyfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                                    echo
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                 <form action="db/bodystart.php" method="post">

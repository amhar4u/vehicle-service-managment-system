...
<div class="table-responsive">
                <?php
                      ...
                      $query="SELECT * FROM booking WHERE ServiceType='5' AND  DATE(Date) = DATE(NOW())";
                ...
                <table class="table table-primary table-striped table-custom table-bordered border-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php  echo 'FullService & repair';?></td>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/fullrepstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/fullrepfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/fullrepstart.php" method="post">

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/notpaidstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/notpaidfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/notpaidstart.php" method="post">

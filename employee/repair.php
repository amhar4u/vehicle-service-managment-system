...
<div class="table-responsive">
                <?php
                     ...
                     $query="SELECT * FROM booking WHERE ServiceType='3' AND  DATE(Date) = DATE(NOW())";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/repstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/repfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/repstart.php" method="post">

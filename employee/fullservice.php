...
<div class="table-responsive">
                <?php
                      ...
                      $query="SELECT * FROM booking WHERE ServiceType='2' AND  DATE(Date) = DATE(NOW())";
                        ...
                        <tr>
                            ...
                            <?php 
                                  if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/fullstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                                    else if($row['Status']=="Started"){
                                    echo 
                                   "<a href=db/fullfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                                  else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/fullstart.php" method="post">

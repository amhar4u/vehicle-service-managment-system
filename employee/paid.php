                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/paidstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/paidfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/paidstart.php" method="post">

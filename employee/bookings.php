                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            if($row['Status']=="Pending") {
                                    ...
                                    echo 
                                    "<a href=db/bookstart.php?id=".$row['id']." class='btn btn-success button-custom'>Start</a>";}

                             else if($row['Status']=="Started"){
                                    echo 
                                    "<a href=db/bookfinish.php?id=".$row['id']." class='btn btn-primary button-custom'>Finished</a>";}
                             else
                            ...
                            { ?>
                                ...
                                {
                                ?>
                                <form action="db/bookstart.php" method="post">

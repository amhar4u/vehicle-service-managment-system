...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <br>
            <a href="adduser.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post"action="postData.php">
                                    ...
                                    <button type="submit" name="deleteuser"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <a href="add repair.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
            <div class="table-responsive">
                <?php
                      $con=mysqli_connect("localhost","root","","tusco");
                      $query = "SELECT * FROM booking WHERE ServiceType='3' ";
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deleterep"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

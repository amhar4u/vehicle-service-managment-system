...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="content">
            ...
            <button type="submit" name="Submit" class="btn btn-success button-custom btn-al" onClick="showMessage()" >Book</button>   
            <a href="service&repair.php" class="btn btn-danger button-custom btn-ali"> CANCEL</button></a>
               <br>
    </form>
            </div>

...
?>
        ...
        <div class="bg">
            ...
            <form  method="POST" action="postData.php">
               ...
               <button type="submit" name="Update" class="btn btn-success button-custom btn-al"onClick="showMessage()"> UPDATE</button>
               <a href="view employee.php" class="btn btn-danger button-custom btn-ali"> CANCEL</button></a>

...
?>
            ...
            <br><br>
               <button type="submit"class="btn btn-success button-custom btn-al  " name="updateor"> Update</button>
               <a href="vieworder.php" class="btn btn-danger button-custom "> CANCEL</button></a>

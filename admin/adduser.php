    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="content">
            ...
            <form  method="POST" action="postData.php">
                ...
                <input type="text" name="NIC" maxlength="12" required="required" data-validation-required-message="Please enter your NIC">
                ...
                <input type="text" name="Contact" maxlength="10" required="required" data-validation-required-message="Please enter your Contactno">
                ...
                <input type="password" name="Password" id="Password"maxlength="12" required="required" data-validation-required-message="Please enter your Password " onChange="onChange()">
                <label class="pass"for="pass">Confirm Password</label>
                <input type="password" name="CPassword" id="CPassword" maxlength="12" required="required" data-validation-required-message="Please enter your Password" onChange="onChange()">
            ...
            <script type="text/javascript">
               ...
               <button class="btn btn-success button-custom"name="adduser" onClick="showMessage()"> ADD</button>
               <a href="view customer.php" class="btn btn-danger button-custom"> CANCEL</button></a>

...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <a href="add repairservice.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
            <div class="table-responsive">
                <?php
                      $con=mysqli_connect("localhost","root","","tusco");
                      $query = "SELECT * FROM booking WHERE ServiceType='4' OR ServiceType='5' ";
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deletesr"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

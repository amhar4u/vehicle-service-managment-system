...
<body>
 ...
 <div class="content">
            ...
            <br><br>
            <div class="bg">
            <h2 class="font">Fill The Booking Details</h2>
            
            <form  method="POST" action="postData.php">
                <label class="nic"for="NIC">Name</label>
                <input type="text" name="name" maxlength="30" required="required" data-validation-required-message="Please enter your ">
                <label class="reg" for="reg">Brand</label>
                <input type="text" name="brand" maxlength="30" required="required" data-validation-required-message="Please enter your " >
                <label class="vehtype" for="vehtype">Quantity</label>
                <input type="text" name="qty" maxlength="30" required="required" data-validation-required-message="Please enter your " >
                <label class="sertype" for="sertype">Price</label>
                <input type="text" name="price" maxlength="30" required="required" data-validation-required-message="Please enter your " >
                <label class="sertype" for="sertype">NIC</label>
                <input type="text" name="nic" maxlength="12" required="required" data-validation-required-message="Please enter your " >
            
                <script type="text/javascript">
                    function showMessage() {
                        alert("Add Stock Successfully.");
                    }
                </script>

            <button type="submit" name="addstock" class="btn btn-success button-custom btn-al"onClick="showMessage()" >Add</button>   
            <a href="view stock.php" class="btn btn-danger button-custom btn-ali"> CANCEL</button></a>
               <br>
    </form>
            </div>

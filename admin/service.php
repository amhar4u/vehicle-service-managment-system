    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Sidebar End -->
         ...
         <div class="content">
            ...
            <br><br>
            <a href="add service.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
            <div class="table-responsive">
                <?php
                      $con=mysqli_connect("localhost","root","","tusco");
                      $query = "SELECT * FROM booking WHERE ServiceType='1' OR ServiceType='2' ";
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deleteser"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

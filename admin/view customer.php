...
<body>
 ...
 <div class="content">
            ...
            <br>
            <a href="add customer.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deletecus"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

...
?>
        ...
        <div class="bg">
            ...
            <form  method="POST" action="postData.php">
                ...
                <input type="text" name="NIC" maxlength="12" value="<?php  echo $row['NIC'];?>">
                ...
                <input type="text" name="Contact" maxlength="10" value="<?php  echo $row['ContactNo'];?>">
                <label class="address" for="address">Address</label>
                <input type="text" name="Address" value="<?php  echo $row['Address'];?>">
                <label class="pass"for="pass">Password</label>
                <input type="password" name="Password" maxlength="12" value="<?php  echo $row['Password'];?>" >
                <label class="role">User Type</label>
                <select name="role" id="role"  value="<?php  echo $row['UserType'];?>" >
               ...
               <button type="submit"class="btn btn-success button-custom btn-al" name="updateuser"onClick="showMessage()"> UPDATE</button>
               <a href="all User.php" class="btn btn-danger button-custom btn-ali"> CANCEL</button></a>

        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="reviews.php" class="nav-item nav-link active"><i class="bi bi-star-fill"></i>Reviews</a>
                ...
                <table class="table table-primary table-striped table-custom table-bordered border-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <form method="post" action="view reviews.php">
                                    <input type="hidden" name="view_id" value="<?php  echo $row['id'];?>">
                                    <button type="submit" name="view"  class="btn btn-success button-custom">View</button>
                               </form>  
                            </td>
                            <td>
                            <form method="post">
                                    <input type="hidden" name="delete_id" value="<?php  echo $row['id'];?>">
                                    <button type="submit" name="delete"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

       ...
       <div class="content">
            ...
            <div class="table-responsive">
                <?php
                      ...
                      $query = "SELECT s.id,s.name,s.brand,s.oquantity,s.price,u.Name,s.ODate
                      FROM stockorder s
                      INNER JOIN user u ON s.eNIC= u.NIC
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deletestk"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

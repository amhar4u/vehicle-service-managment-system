...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <a href="add bookings.php" class="btn btn-primary button-custom btn-align"> + ADD</button></a>
            <br><br>
                        ...
                        <tr>
                            ...
                            <td>
                               <form method="post" action="postData.php">
                                    ...
                                    <button type="submit" name="deletebook"  class="btn btn-danger button-custom">Delete</button>
                               </form>
                            </td>
                        </tr>
                        <?php

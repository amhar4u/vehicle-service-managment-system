            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="bi bi-calendar-week"></i>Booking</a>
...
?>
        ...
        <div class="bg">
            ...
            <form  method="POST" action="postData.php">
                ...
                <input type="text" name="regno" maxlength="12" value="<?php  echo $row['VehicleRno'];?>" >
                <label class="vehtype" for="vehtype">Vehicle Type</label>
                <select name="vtype" id="vtype" value="<?php  echo $row['VehicleType'];?>">
            ...
            <br>
                 ...
                 <script type="text/javascript">
                    function showMessage() {
                        alert("Edit Repair & Service Successfully.");
                    }
                </script>
               <button type="submit"class="btn btn-success button-custom btn-al" name="update"onClick="showMessage()"> UPDATE</button>

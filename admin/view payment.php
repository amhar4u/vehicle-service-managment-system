        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="view payment.php" class="nav-item nav-link active"><i class="bi bi-credit-card"></i>Payment</a>
                ...
                <table class="table table-primary table-striped table-custom table-bordered border-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="paymentdetails.php"class="btn btn-success button-custom" >View</button></a>
                            </td>
                            <td>
                            <form method="post">
